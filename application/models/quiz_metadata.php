<?php
class Quiz_metadata extends CI_Model {
	function __construct(){
        // Call the Model constructor
        parent::__construct();
    }

	public function quiz_metadatadetails(){

        $aColumns = array('id','points','time','1' );
        		...
        		foreach ($rResult->result_array() as $aRow){
        			...
        			for ( $i=0 ; $i<count($aColumns) ; $i++ ){
        				if ( $aColumns[$i] == 'id' ){
                            ...
                            $row[] = '<a class="small black button" href="../quiz_metadata" id="test" style="text-decoration:none;">Start Quiz</a>';
                            }
