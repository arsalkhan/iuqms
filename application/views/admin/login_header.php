...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ADMIN_ASSETS; ?>styles/jquery.jcarousel.css" type="text/css" media="all" />
    ...
    <script type="text/javascript" src="<?php echo ADMIN_ASSETS; ?>scripts/jquery-1.4.2.min.js"></script>
    <script type="text/javascript" src="<?php echo ADMIN_ASSETS; ?>scripts/jquery.jcarousel.pack.js"></script>
    <script type="text/javascript" src="<?php echo ADMIN_ASSETS; ?>scripts/func.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo ADMIN_ASSETS; ?>styles/style_home.css" type="text/css" media="screen" />
