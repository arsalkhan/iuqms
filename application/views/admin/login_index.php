...
function loginValidation(){
	...
	if(username == ''){
		...
		ajax('<?php echo SITE_URL; ?>administrator/validateCheck/','form2','errorDiv','contentSpinner');
		return false;
	}
}
</script>
...
<div class="border">
    <!--`Header-->
    <div id="header">
        <div id="logo"><a href="#" class="notext">IUQMS</a></div>
        ...
        <ul>
            <li>
                <div class="item">
                    ...
                    <img src="<?php echo ADMIN_ASSETS; ?>images/slider01.jpg" alt="" /> </div>
            </li>
            <li>
                <div class="item">
                    <div class="text">
                    ...
                    <img src="<?php echo ADMIN_ASSETS; ?>images/slider02.jpg" alt="" /> </div>
            </li>
            <li>
                <div class="item">
                    <div class="text">
                        <h3><em> easy</em></h3>
                        <p><em>process</em></p></div>
                    <img src="<?php echo ADMIN_ASSETS; ?>images/slider03.jpg" alt="" /> </div>
            </li>
            <li>
                <div class="item">
                    <div class="text">
                    ...
                    <img src="<?php echo ADMIN_ASSETS; ?>images/slider04.jpg" alt="" /> </div>
            </li>
        </ul>
    </div>
    <!--`End Slider-->
    ...
    <!--`Main-->
    <div id="errorDiv"> </div>
       <div id="contentSpinner" style="display:none">Loading....</div>
    <div id="main">
        <div id="content" class="left">
                         ...
                         <div class="input">
                             <label style="width:55.8em;">
                                  ...
                                  <select id="user_type" name="user_type">
                                      ...
                                      $result = mysql_query('SELECT * from user_type') or die(mysql_error());
            ...
            <div class="details">
                ...
                <div class="item">
                    ...
                    <p>&nbsp;</p>
                    <p><strong>Advantages  of the project</strong></p>
                    <p><br>
